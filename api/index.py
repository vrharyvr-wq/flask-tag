...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "73E76"  # Playfab Title Id
        self.SecretKey: str = "BT89PTDKQX546E4YZ4K4S1QDPWB54XWA5DKZRDEPWITRK8DQII"  # Playfab Secret Key
        self.ApiKey: str = "OC|1194208077109709|5caa0d1d6846b6793c2bc5710ae818b0"  # App Api Key (Oculus/Graph API)
